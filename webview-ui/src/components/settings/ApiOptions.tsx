				...
				<div>
					...
					<p
						...
						<span style={{ color: "var(--vscode-errorForeground)" }}>
							(<span style={{ fontWeight: 500 }}>Note:</span> EdgeAICoder uses complex prompts and works best with
...
export function getOpenRouterAuthUrl(uriScheme?: string) {
	return `https://openrouter.ai/auth?callback_url=${uriScheme || "vscode"}://edge.edgeaicoder/openrouter`
}
